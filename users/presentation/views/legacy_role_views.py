...
from ...presentation.serializers.legacy_role_serializers import RoleAssignmentSerializer
from ...presentation.permissions.permissions import CanManageRoles, IsAdminUser
from ...application.services.legacy_role_services import (
